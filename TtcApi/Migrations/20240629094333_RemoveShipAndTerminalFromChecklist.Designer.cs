...
namespace TtcApi.Migrations
{
    ...
    [Migration("20240629094333_RemoveShipAndTerminalFromChecklist")]
    partial class RemoveShipAndTerminalFromChecklist
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VeiligheidsChecklist", b =>
                {
                    ...
                    b.HasOne("TtcApi.Models.Ship", null)
                        .WithMany("VeiligheidsChecklists")
                        .HasForeignKey("ShipName");

                    b.HasOne("TtcApi.Models.Terminal", null)
                        .WithMany("VeiligheidsChecklists")
                        .HasForeignKey("TerminalName");
